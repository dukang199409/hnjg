...
public class SerialPortUtils implements SerialPortEventListener {
            ...
            if (commPortId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
                ...
                if (paramConfig.getSerialNumber().equals(commPortId.getName())) {
                    ...
                    try {
                        ...
                        throw new BSLException(305,"端口被占用");
                    } catch (TooManyListenersException e) {
                        throw new BSLException(306,"监听器过多");
                    } catch (UnsupportedCommOperationException e) {
                        throw new BSLException(307,"不支持的COMM端口操作异常");
                    }
                    // 结束循环
                    break;
                }
    ...
    public void readComm() {
        try {
            ...
            throw new BSLException("读取串口数据时发生IO异常");
        }
    }
    ...
    public void sendComm(String data) {
        ...
        try {
            ...
            throw new BSLException("找不到串口。");
        } catch (IOException e) {
            throw new BSLException("发送信息到串口时发生IO异常");
        }
    }
        ...
        if (serialPort != null) {
            ...
            if (inputStream != null) {
                try {
                    ...
                    throw new BSLException("关闭输入流时发生IO异常");
                }
            }
            if (outputStream != null) {
                try {
                    ...
                    throw new BSLException("关闭输出流时发生IO异常");
                }
            }
            serialPort.close();
            serialPort = null;
