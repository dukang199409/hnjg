...
public class BslLunoQuality {
    private String luId;

    private String luCompany;

    private Integer chemicalC;
    ...
    private Float mechanicalS;

    private Float mechanicalB;

    private Float mechanicalL;

    private Float impactT;
    ...
    public void setLuCompany(String luCompany) {
        this.luCompany = luCompany == null ? null : luCompany.trim();
    }
    ...
    public Float getMechanicalS() {
        return mechanicalS;
    }

    public void setMechanicalS(Float mechanicalS) {
        this.mechanicalS = mechanicalS;
    }

    public Float getMechanicalB() {
        return mechanicalB;
    }

    public void setMechanicalB(Float mechanicalB) {
        this.mechanicalB = mechanicalB;
    }

    public Float getMechanicalL() {
        return mechanicalL;
    }

    public void setMechanicalL(Float mechanicalL) {
        this.mechanicalL = mechanicalL;
    }

    public Float getImpactT() {
        return impactT;
    }

    public void setImpactT(Float impactT) {
    ...
    public void setImpactN1(String impactN1) {
        this.impactN1 = impactN1 == null ? null : impactN1.trim();
    }
    ...
    public void setImpactN2(String impactN2) {
        this.impactN2 = impactN2 == null ? null : impactN2.trim();
    }
    ...
    public void setImpactN3(String impactN3) {
        this.impactN3 = impactN3 == null ? null : impactN3.trim();
    }
    ...
    public void setBendwc(String bendwc) {
        this.bendwc = bendwc == null ? null : bendwc.trim();
    }
    ...
    public void setBendyb(String bendyb) {
        this.bendyb = bendyb == null ? null : bendyb.trim();
    }
