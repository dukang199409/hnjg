...
public class BslMakePlanInfoDetailJoinInfo {
    ...
    private String planLunoZ;

    private String planStatusZ;

    private String prodNormZ;

    private Float prodWeightZ;

    private Integer prodNumZ;

    private String prodMaterialZ;

    private String makeTypeZ;

    private String prodOrderZ;

    private String makeNameZ;

    private String makeProdNormZ;

    public String getPlanLunoZ() {
		return planLunoZ;
	}

	public void setPlanLunoZ(String planLunoZ) {
		this.planLunoZ = planLunoZ;
	}

	public String getPlanStatusZ() {
		return planStatusZ;
	}

	public void setPlanStatusZ(String planStatusZ) {
		this.planStatusZ = planStatusZ;
	}

	public String getProdNormZ() {
		return prodNormZ;
	}

	public void setProdNormZ(String prodNormZ) {
		this.prodNormZ = prodNormZ;
	}

	public Float getProdWeightZ() {
		return prodWeightZ;
	}

	public void setProdWeightZ(Float prodWeightZ) {
		this.prodWeightZ = prodWeightZ;
	}

	public Integer getProdNumZ() {
		return prodNumZ;
	}

	public void setProdNumZ(Integer prodNumZ) {
		this.prodNumZ = prodNumZ;
	}

	public String getProdMaterialZ() {
		return prodMaterialZ;
	}

	public void setProdMaterialZ(String prodMaterialZ) {
		this.prodMaterialZ = prodMaterialZ;
	}

	public String getMakeTypeZ() {
		return makeTypeZ;
	}

	public void setMakeTypeZ(String makeTypeZ) {
		this.makeTypeZ = makeTypeZ;
	}

	public String getProdOrderZ() {
		return prodOrderZ;
	}

	public void setProdOrderZ(String prodOrderZ) {
		this.prodOrderZ = prodOrderZ;
	}

	public String getMakeNameZ() {
		return makeNameZ;
	}

	public void setMakeNameZ(String makeNameZ) {
		this.makeNameZ = makeNameZ;
	}

	public String getMakeProdNormZ() {
		return makeProdNormZ;
	}

	public void setMakeProdNormZ(String makeProdNormZ) {
		this.makeProdNormZ = makeProdNormZ;
	}
