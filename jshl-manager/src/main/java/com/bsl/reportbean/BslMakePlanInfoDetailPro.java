...
public class BslMakePlanInfoDetailPro {
    ...
    private Float prodMakeWeight;

    public Float getProdMakeWeight() {
		return prodMakeWeight;
	}

	public void setProdMakeWeight(Float prodMakeWeight) {
		this.prodMakeWeight = prodMakeWeight;
	}
