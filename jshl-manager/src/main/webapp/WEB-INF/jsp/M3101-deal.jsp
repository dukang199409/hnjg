...
<div style="padding:10px 10px 10px 10px">
	<form id="dclProdForm" class="itemForm" method="post">
	   <table>
	        <tr>
	            <td width="120"  align="right">待处理品编号:</td>
	            <td width="210"  align="right">
	            	<input name="prodOriId" id="prodOriIdM3101" class="easyui-textbox" readonly="readonly" data-options="required:false" style="width:200px;"/>
	            </td>      
	        ...
	        <tr>  
	             ...
	             <td width="210" align="right">
	            	<input name="prodLuno" id="prodLunoM3101" class="easyui-textbox" type="text" data-options="required:true,validType:'length[0,40]'" style="width:200px;"></input>
	            </td> 
	            <td width="120" align="right">产品规格:</td>
	             <td width="210" align="right">
	            	<input name="prodNorm" id="prodNormM3101" class="easyui-textbox" type="text" data-options="required:true,validType:'length[0,40]'" style="width:200px;"></input>
	            </td> 
	        </tr>
	        <tr>
	            <td width="120" align="right">产品定尺(米):</td>
	            <td width="210" align="right">
	            	<input name="prodLength" id="prodLengthM3101"  class="easyui-numberbox" type="text" data-options="required:true,min:0,precision:3,validType:'length[0,10]'" style="width:200px;"></input>
	            </td>
	            <td width="120" align="right">产品名称:</td>
	            <td width="210" align="right">
	            	<input name="prodName" id="prodNameM3101" class="easyui-textbox" type="text" data-options="required:true,validType:'length[0,40]'" style="width:200px;"></input>
	            </td> 
	        </tr>
	        <tr>
	           <td width="120" align="right">质量等级:</td>
	            <td width="210" align="right">
	            	<select name="prodLevel" id="prodLevelM3101" class="easyui-combobox" panelHeight="auto" data-options="editable:true" style="width:200px;">
			         <option value="">请选择...</option>
	        ...
	        <tr hidden="true">
	            ...
	            <td width="210" align="right">
	            	<input name="prodInputuser" id="prodInputuserM3101" class="easyui-textbox" type="text" data-options="required:false" style="width:200px;"></input>
	            </td>
		    </tr>	
	    </table>
	</form>
	<div style="margin-top:10px" align="center">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitM3101DealForm()">提交</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="closeM3101DealForm()">关闭</a>
	</div>
</div>
<script type="text/javascript">
	...
	//提交表单
	function submitM3101DealForm(){
		
		//记录录入人员信息
		var inputUser = $("#user_id").html();
		$("#prodInputuserM3101").textbox('setValue',inputUser);
		var sumNum = $("#sumNumM3101").numberbox('getValue');
		//有效性验证
		if(!$('#dclProdForm').form('validate')){
		...
		$.messager.confirm('确认','是否确认入库？',function(r){
			if (r){
				$.post("/prodManager/addProdByDCL",$("#dclProdForm").serialize(), function(data){
					if(data.status == 200){
						var prodId = data.data;
						$.messager.confirm('提示','产品入库成功!起始单号为：'+prodId+"；是否将该处理品状态更新为全部处理完成？",function(rn){
							if (rn){
								var params = {"prodId":$("#prodOriIdM3101").textbox('getValue'),"user":inputUser};
