...
<div style="padding:10px 10px 10px 10px">
	<form id="prodWxInfoEditForm" class="itemForm" method="post">
	   <table>
	         <tr>
	        ...
	        <tr> 
	           <td width="120" align="right">单包支数:</td>
	            ...
	            <td width="120" align="left">
	        		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="getWeightEditM3103()" style="width:70px;">称重</a>
	        	</td>
	        </tr>
	        <tr>
...
<script type="text/javascript">
	...
	function submitM3103EditForm(){
		...
		//有效性验证
		if(!$('#prodWxInfoEditForm').form('validate')){
			$.messager.alert('提示','表单还未填写完成!');
			return;
		}
		//ajax的post方式提交表单
		//$("#itemAddForm").serialize()将表单序列号为key-value形式的字符串
		$.post("/prodWxManager/editProd",$("#prodWxInfoEditForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','修改产品信息成功!单号为：'+data.data,'info',function(){
					$("#prodWxEditWindow").window('close');
					searchM3103Form();
