...
<div>
	<div class="easyui-panel" title="产品信息查询" style="padding:10px 10px 10px 10px">
	 ...
	 <table class="easyui-datagrid" id="prodAddInfoList" title="产品信息"  style="height:570px"
